...
_ENV_MAP = {
    ...
    "v5_signal_reverse_min_minutes": "V5_SIGNAL_REVERSE_MIN_MINUTES",
...
DEFAULTS = {
    ...
    "v5_max_concurrent":          3,
    "v5_max_extensions":          15,
    "v5_signal_reverse_min_minutes": 30,
...
PARAM_META = {
    ...
    "v5_max_extensions":          (0, 50, "次", "AI 续仓上限 (15 = 240min 窗口,实验最优)"),
    "v5_signal_reverse_min_minutes": (0, 240, "分钟", "SIGNAL_REVERSE 最短持仓门槛 (0=立即生效;30=4h 窗口内防抢跑)"),
